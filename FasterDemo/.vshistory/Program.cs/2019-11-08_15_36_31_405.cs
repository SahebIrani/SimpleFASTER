...
namespace FasterDemo
{
      ...
      public class MyLongSerializer : BinaryObjectSerializer<int>
      {
            public override void Serialize(ref int key) => writer.Write(key);
            public override void Deserialize(ref int key) => key = reader.ReadInt32();
      }
      ...
      class Program
      {
            static void Main(string[] args)
            {
                  ...
                  Status read = fht.Read(ref key, ref input, ref output, Empty.Default, 0);
