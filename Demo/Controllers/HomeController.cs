...
namespace Demo.Controllers
{
      ...
      public class HomeController : Controller
      {
            ...
            {
                  IDevice log = Devices.CreateLogDevice(Path.GetTempPath() + "SinjulMSBH.log", true, false, -1, false);
                  IDevice objlog = Devices.CreateLogDevice(Path.GetTempPath() + "SinjulMSBH.obj.log", true, false, -1, false);

                  FasterKV<long, long, long, long, Empty, Funcs> fht = new FasterKV<long, long, long, long, Empty, Funcs>
                    (1L << 20,
                                new Funcs(),
                                new LogSettings
                                {
                  ...
                  IEnumerable<KeyValuePair<long, long>> result = readData.Take(44).ToList();
